...
//EMAIL----------------------------------------------------------------------------------------------------
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setEmail('');
      setMessage('');
      setMessageStatus('Thank you for your message!! I will respond as soon as I have the opportunity to review it.');
            ...
            <div className="homeContainer" id='home'>
                <div className="c-1">
                    <div className="myTechStack">
                        ...
                        <h2><Typewriter
                                options={{
                                strings: ["FRONT-END DEVELOPMENT","JAVASCRIPT","TYPESCRIPT","REACT","ANGULAR","VUE","NEXT-JS","AGILE-SCRUM"],
                                autoStart: true,
                                loop: true,
                                }}
                        /></h2>
                ...
                <div className="c-2">
                    <div className="typingGreetings">
                      <p>Hi Good day!! Im <span style={{color: 'cyan'}}> Arnaiz Jhon , </span> A software engineer who thrives on coffee and coding.</p>
                    </div>
                </div>
                ...
                <div className="c-4">
                   <a className='button' href="https://www.linkedin.com/in/markjarnaiz/" target="_blank" rel="noreferrer">
                      <span></span><span></span>
                      <span></span><span></span>
                        LINKEDiN
                    </a>
                    <a className='button' href="https://github.com/scmarkj0307" target="_blank" rel="noreferrer">
                      <span></span><span></span>
                      <span></span><span></span>
                        GITHUB
                    </a>
                    <a className='button' href="https://drive.google.com/file/d/1VTLxDjQc_q6J_X2bTF--rjQN3z93jeqz/view?usp=sharing" target="_blank" rel="noreferrer">
                      <span></span><span></span>
                      <span></span><span></span>
                        CV
                    </a>
            ...
            <div className="cContainer">
              <div className="cc1">
                <lord-icon
                    ...
                    trigger="loop"
                    delay="2000"
                    colors="primary:#94a3b8,secondary:#B7ADA1"
                ...
                <div className="contactForm">
                  ...
                  <form onSubmit={handleSubmit} className="form-container">
                    ...
                    {/* Display the message status */}
                      {messageStatus && (
                        <div style={{color: 'white', backgroundColor: '#3D5872'}}className={`message-status ${messageStatus.includes('successfully') ? 'success' : 'error'}`}>
                          {messageStatus}
                        </div>
                      )}
                  </form>
              ...
              <lord-icon
                  ...
                  trigger="loop"
                  delay="2000"
                  colors="primary:#B7ADA1,secondary:#94a3b8"
                  style={{ width: '250px', height: '250px' }}>
              </lord-icon>
            </div>
          </div>
